...
# #Decision Trees i Random forest su ostvarili bolji accuracy nego da smo pretpostavili sve 0 (76%)- accuracy paradox
# #Decision Trees i Random Forest su overfitani na trening setu- ako smanjimo overfitanje mogucnost generalizacije ce se povecati i potencijalno dobijamo bolje rezultate
