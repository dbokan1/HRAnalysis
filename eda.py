...
# plt.show()
#prva kategorija koja je relativno balansirana, iako kategorija >20 je veća od ostalih, prestavlja samo 3000 elemenata, velik broj podjednako zastupljenih kategorija

# sns.countplot(x=relevant.columns[8], alpha=0.7, data=relevant, order=["<10","10/49","50-99","100-500","500-999","1000-4999","5000-9999","10000+"])
# plt.show()
#podaci su balansirani, najvise ima u opsegu 50-99(oko 3000)

# sns.countplot(x=relevant.columns[9], alpha=0.7, data=relevant)
# plt.show()
#kolona je disbalansirana, Pvt Ltd ima oko 10k elemenata, ostali znatno manje

# sns.countplot(x=relevant.columns[10], alpha=0.7, data=relevant)
# plt.show()
#jedna kategorija je dominantno zastupljena, ostale su balansirane
